...
function prestoHourRange(range, interval, currentDate) {
  if (currentDate === void 0) {
    currentDate = dayjs__default['default']().startOf('d').toISOString()
  }
  var result = []
  var rangeArray = range.split('-')
  var _a = rangeArray[0].split(':'),
    _b = _a[0],
    startHour = _b === void 0 ? 0 : _b,
    _c = _a[1],
    startMinute = _c === void 0 ? 0 : _c
  var _d = rangeArray[1].split(':'),
    _e = _d[0],
    endHour = _e === void 0 ? 24 : _e,
    _f = _d[1],
    endMinute = _f === void 0 ? 0 : _f
  ...
  if (endMinute > 0) {
    var ceilNumber = interval > 0 ? Math.ceil(endMinute / interval) : endMinute
...
function useCalendarTouchableOpacityProps(_a) {
  ...
  var touchableOpacityProps = {
    ...
    style: __spreadArray(__spreadArray([eventCellCss.style], injectedStyles, true), [
...
var HourGuideCell = function (_a) {
  ...
  return React__namespace.createElement(
    ...
    React__namespace.createElement(
      ...
      React__namespace.createElement(reactNative.View, {
        style: { height: cellHeight / 4, width: '100%' },
      }),
    ),
  )
}
...
var HourGuideColumn$1 = React__namespace.memo(_HourGuideColumn$1, function () {
  return true
})
...
function _CalendarBody(_a) {
  var containerHeight = _a.containerHeight,
    ...
    _e = _a.showHourGuide,
    showHourGuide = _e === void 0 ? true : _e,
    _f = _a.hourRange,
    hourRange = _f === void 0 ? '0-23' : _f,
    multipleColumnData = _a.multipleColumnData,
    numberOfColumn = _a.numberOfColumn
    ...
    React__namespace.createElement(
      ...
      multipleColumnData && multipleColumnData.length > 0
        ? React__namespace.createElement(
            ...
            React__namespace.createElement(reactNative.View, {
              style: [u['z-20'], u['w-70'], { height: 100, backgroundColor: theme.palette.cellBg }],
            }),
              ...
              return React__namespace.createElement(
                ...
                column.image_url &&
                  React__namespace.createElement(
                    reactNative.View,
                    null,
                    React__namespace.createElement(reactNative.Image, {
                ...
                React__namespace.createElement(
                  reactNative.View,
                  { style: [{ width: 150, paddingVertical: 10 }] },
                  React__namespace.createElement(
                    reactNative.Text,
                    { style: { color: theme.palette.headingColor, textAlign: 'center' } },
                    column.title,
                  ),
                ),
              )
      ...
      React__namespace.createElement(
        ...
        __assign(
          {
            style: [
              ...
              multipleColumnData && multipleColumnData.length > 0 ? { overflow: 'scroll' } : {},
            ],
          },
          reactNative.Platform.OS === 'web' ? panResponder.panHandlers : {},
        ),
        showHourGuide
          ? React__namespace.createElement(
              reactNative.View,
              { style: [u['z-20'], u['w-70'], { marginTop: -1 }] },
              hoursRange(hourRange).map(function (hour) {
                return React__namespace.createElement(HourGuideColumn$1, {
                  key: hour,
          ...
          ? multipleData[page].map(function (column) {
              return dateRange.map(function (date) {
                return React__namespace.createElement(
                  ...
                  hoursRange(hourRange).map(function (hour, index) {
                  ...
                  column.data
                    .filter(function (data) {
                      return dayjs__default['default'](data.start).isBetween(
                        date.startOf('day'),
                        date.endOf('day'),
                        null,
                        '[)',
                    ...
                    .map(function (event) {
                      return __assign(__assign({}, event), {
                        end: dayjs__default['default'](event.end).isAfter(
                  ...
                  column.data
                    .filter(function (data) {
                      return (
                        dayjs__default['default'](data.start).isBefore(date.startOf('day')) &&
                        dayjs__default['default'](data.end).isBetween(
                          date.startOf('day'),
                          date.endOf('day'),
                          null,
                          '[)',
      ...
      ? React__namespace.createElement(
          ...
          React__namespace.createElement(
            ...
            React__namespace.createElement(
              ...
              React__namespace.createElement(
                reactNative.Text,
                { style: { color: theme.palette.headingColor } },
                '< PREV',
              ),
            ),
          ),
          ...
          React__namespace.createElement(
            ...
            {
              onPress: function () {
                if (multipleData[page + 1]) setPage(page + 1)
              },
            },
            React__namespace.createElement(
              reactNative.View,
...
function _CalendarContainer(_a) {
  var _b = _a.events,
    ...
    _e = _a.hideNowIndicator,
    hideNowIndicator = _e === void 0 ? false : _e,
    _f = _a.showAdjacentMonths,
    showAdjacentMonths = _f === void 0 ? false : _f,
    _g = _a.mode,
    mode = _g === void 0 ? 'week' : _g,
    overlapOffset = _a.overlapOffset,
    _h = _a.scrollOffsetMinutes,
    scrollOffsetMinutes = _h === void 0 ? 0 : _h,
    _j = _a.showTime,
    showTime = _j === void 0 ? true : _j,
    _k = _a.headerContainerStyle,
    headerContainerStyle = _k === void 0 ? {} : _k,
    _l = _a.headerContentStyle,
    headerContentStyle = _l === void 0 ? {} : _l,
    _m = _a.dayHeaderStyle,
    dayHeaderStyle = _m === void 0 ? {} : _m,
    _o = _a.dayHeaderHighlightColor,
    dayHeaderHighlightColor = _o === void 0 ? '' : _o,
    _p = _a.weekDayHeaderHighlightColor,
    weekDayHeaderHighlightColor = _p === void 0 ? '' : _p,
    _q = _a.bodyContainerStyle,
    bodyContainerStyle = _q === void 0 ? {} : _q,
    _r = _a.swipeEnabled,
    swipeEnabled = _r === void 0 ? true : _r,
    _s = _a.weekStartsOn,
    weekStartsOn = _s === void 0 ? 0 : _s,
    ...
    renderEvent = _a.renderEvent,
    _t = _a.renderHeader,
    HeaderComponent = _t === void 0 ? CalendarHeader : _t,
    _u = _a.renderHeaderForMonthView,
    HeaderComponentForMonthView = _u === void 0 ? CalendarHeaderForMonthView : _u,
    _v = _a.weekEndsOn,
    weekEndsOn = _v === void 0 ? 6 : _v,
    _w = _a.maxVisibleEventCount,
    maxVisibleEventCount = _w === void 0 ? 3 : _w,
    _x = _a.eventMinHeightForMonthView,
    eventMinHeightForMonthView = _x === void 0 ? 22 : _x,
    activeDate = _a.activeDate,
    _y = _a.headerComponent,
    headerComponent = _y === void 0 ? null : _y,
    _z = _a.headerComponentStyle,
    headerComponentStyle = _z === void 0 ? {} : _z,
    _0 = _a.hourStyle,
    hourStyle = _0 === void 0 ? {} : _0,
    _1 = _a.showAllDayEventCell,
    showAllDayEventCell = _1 === void 0 ? true : _1,
    _2 = _a.showHourGuide,
    showHourGuide = _2 === void 0 ? true : _2,
    hourRange = _a.hourRange,
    multipleColumnData = _a.multipleColumnData,
    numberOfColumn = _a.numberOfColumn
  var _3 = React__default['default'].useState(dayjs__default['default'](date)),
    targetDate = _3[0],
    setTargetDate = _3[1]
  React__default['default'].useEffect(
    function () {
...
function _Calendar(_a) {
  var _b = _a.theme,
    ...
    isRTL = _a.isRTL,
    showHourGuide = _a.showHourGuide,
    hourRange = _a.hourRange,
    props = __rest(_a, ['theme', 'isRTL', 'showHourGuide', 'hourRange'])
  ...
  return React__default['default'].createElement(
    ...
    React__default['default'].createElement(
      CalendarContainer,
      __assign({}, props, { showHourGuide: showHourGuide, hourRange: hourRange }),
    ),
  )
}
...
var _HourGuideColumn = function (_a) {
  var cellHeight = _a.cellHeight,
    ...
    _b = _a.hourStyle,
    hourStyle = _b === void 0 ? {} : _b,
    _c = _a.hourContainerStyle,
    hourContainerStyle = _c === void 0 ? {} : _c
  var theme = useTheme()
  var textStyle = React__namespace.useMemo(
    function () {
      return { color: theme.palette.gray[500], fontSize: theme.typography.xs.fontSize }
  ...
  return React__namespace.createElement(
    reactNative.View,
    {
      style: [
        ...
        objHasContent(hourContainerStyle) ? hourContainerStyle : {},
      ],
    },
    React__namespace.createElement(
      reactNative.Text,
...
function PrestoCalendar$1(_a) {
  var headerComponent = _a.headerComponent,
    hourRange = _a.hourRange,
    headerComponentStyle = _a.headerComponentStyle,
    hourStyle = _a.hourStyle,
    _b = _a.interval,
    interval = _b === void 0 ? 30 : _b,
    eventData = _a.eventData,
    _c = _a.currentDate,
    currentDate = _c === void 0 ? dayjs__default['default']().startOf('d').toISOString() : _c,
    _d = _a.renderCell,
    renderCell = _d === void 0 ? null : _d,
    _e = _a.cellHeight,
    cellHeight = _e === void 0 ? 90 : _e,
    hourContainerStyle = _a.hourContainerStyle,
    calendarStyle = _a.calendarStyle,
    scrollOffsetMinutes = _a.scrollOffsetMinutes,
    style = _a.style,
    _f = _a.containerHeight,
    containerHeight = _f === void 0 ? 700 : _f,
    mode = _a.mode,
    onPressEvent = _a.onPressEvent,
    renderEvent = _a.renderEvent,
    renderEmptySlots = _a.renderEmptySlots,
    _g = _a.showEmptySlots,
    showEmptySlots = _g === void 0 ? false : _g,
    onPressEmptySlot = _a.onPressEmptySlot
  var theme = useTheme()
  ...
  var getEventCellPositionStyle = function (start, end) {
    var relativeHeight =
      (dayjs__default['default'](end).diff(start, 'minute') * cellHeight) / interval
    var relativeTop =
      (dayjs__default['default'](start).diff(hoursRangeArr[0].startTime, 'minute') * cellHeight) /
      interval
    return {
  ...
  var renderPrestoEvent = function (event) {
    return React__default['default'].createElement(
      reactNative.TouchableOpacity,
      {
        style: __assign(
      ...
      renderEvent
        ...
        : React__default['default'].createElement(
            ...
            React__default['default'].createElement(
              reactNative.Text,
              { style: __assign(__assign({}, eventTimeStyle), { marginTop: 5 }) },
  ...
  return React__default['default'].createElement(
    ...
    React__default['default'].createElement(
      reactNative.ScrollView,
      {
        contentContainerStyle: __assign(__assign({}, calendarStyle), { overflow: 'hidden' }),
        style: [
          {
            height: containerHeight - cellHeight * 3,
          },
      ...
      React__default['default'].createElement(
        ...
        React__default['default'].createElement(
          ...
          hoursRangeArr.map(function (item) {
            return React__default['default'].createElement(HourGuideColumn, {
              key: item.startTime,
              cellHeight: cellHeight,
              hour: dayjs__default['default'](item.startTime).format('hh:mm A'),
              ampm: true,
              hourStyle: hourStyle,
        ...
        React__default['default'].createElement(
          ...
          mode === 'detailed'
            ? eventData
                .filter(function (data) {
                  return dayjs__default['default'](data.startDate).isBetween(
                    date.startOf('day'),
                    date.endOf('day'),
                    null,
                    '[)',
            ...
            : data.map(function (event, index) {
                return React__default['default'].createElement(
                  ...
                  renderCell
                    ? renderCell(event)
                    : React__default['default'].createElement(DefaultEventRenderer, {
                        event: event,
                        cellHeight: cellHeight,
                      }),
                )
            ...
            ? data.map(function (event, index) {
                return React__default['default'].createElement(
                  ...
                  renderEmptySlots
                    ...
                    : React__default['default'].createElement(DefaultEmptySlotRenderer, {
                        event: event,
                        cellHeight: cellHeight,
